# -abhishekspawar0803-svg
Electrical engineering undergrad applying ML to power systems, batteries, and embedded systems, growing from simple Keras experiments to SOH/RUL prediction, grid anomaly detection, PINNs, and YOLO-based inspection.
...
- [battery_life_cycle_nasa](https://github.com/abhishekspawar0803-svg/battery_life_cycle_nasa)  
  LSTM-based SOH/RUL prediction on NASA Li-ion cycle data in PyTorch.

- [power_grid](https://github.com/abhishekspawar0803-svg/power_grid)  
  Deep learning-based grid event/anomaly detection using sequence models and reconstruction error.

- [pinn](https://github.com/abhishekspawar0803-svg/pinn)  
